...
public class SecurityConfig {
	...
	/* 오소리 서버에 오소리 코드 요청 URL 
		 ...
		 오소리 서버에 접근 토큰 요청 URL
		 http://localhost:8080/oauth2/token?client_id=client&redirect_uri=https://springone.io/authorized&grant_type=authorization_code
		 <= code 및 code_verifier params 탭에서 추가 제출필요!
	 */
	@Bean
	@Order(1)
